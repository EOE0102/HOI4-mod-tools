...
def main():
    ...
    for map_file in os.listdir(country_map_folder_location):
        if map_file.endswith(".bmp"): #TOO BIG
        #if map_file.endswith(".png"): #PRGA
        #if map_file.endswith(".jpg"): #too grorn
    ...
    textfile = open(export_folder_location + "/common/country_tags/EOE_B_Submod11_More_Countries_countries.txt", "w")
    for element in common_country_tags:
        textfile.write(element)
    textfile.close()

    #localisation/english 
    textfile = open(export_folder_location + "/localisation/english/EOE_B_Submod11_More_Countries_countries_l_english.txt", "w")
    textfile.write('l_english:\r\n')
    ...
    textfile = open(export_folder_location + "/common/countries/EOE_B_Submod11_More_Countries_cosmetic.txt", "w")
